...
int main(int argc, char* argv[])
{
    ...
    std::string vertexShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial10/Shaders/Main.vs));
    ...
    std::string tesselationControlShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial10/Shaders/Main.tcs));
    ...
    std::string tesselationEvaluationShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial10/Shaders/Main.tes));
    ...
    std::string geometryShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial10/Shaders/Main.gs));
    ...
    std::string fragmentShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial10/Shaders/Main.fs));
