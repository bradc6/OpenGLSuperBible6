...
int main(int argc, char* argv[])
{
    ...
    std::cout << "Shader Dir: " << QUOTE(SOURCEDIR/Source/Tutorial18/Shaders/Main.glsl.vert) << '\n';
    std::string vertexShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial18/Shaders/Main.glsl.vert));
    ...
    std::string fragmentShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial18/Shaders/Main.glsl.frag));
