...
int main(int argc, char* argv[])
{
    ...
    std::string vertexShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.vs.glsl));
    ...
    std::string tesselationControlShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.tcs.glsl));
    ...
    std::string tesselationEvaluationShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.tes.glsl));
    ...
    std::string geometryShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.gs.glsl));
    ...
    std::string fragmentShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.fs.glsl));
