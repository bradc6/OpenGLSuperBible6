...
//We will create our first simple geometery shader
...
int main(int argc, char* argv[])
{
    ...
    std::string vertexShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.glsl.vert));
    ...
    std::string tesselationControlShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.glsl.tesc));
    ...
    std::string tesselationEvaluationShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.glsl.tese));
    ...
    std::string geometryShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.glsl.geom));
    ...
    std::string fragmentShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial9/Shaders/Main.glsl.frag));
    ...
    //We will change the OpenGL point size to better see them
    glPointSize(5.0);
