...
//Keep all the shaders of a particular pipeline together.
struct ShaderPipelinePrograms
{
    GLuint computeShaderProgram = glNULL;
    GLuint vertexShaderProgram = glNULL;
    GLuint tesselationControlShaderProgram = glNULL;
    GLuint tesselationEvaluationShaderProgram = glNULL;
    GLuint geometryShaderProgram = glNULL;
    GLuint fragmentShaderProgram = glNULL;
};
