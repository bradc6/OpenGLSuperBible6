...
//from them. We will send multiple objects from the vertex shader to the fragment shader
//in a bulk fashion. (Similar to that in a C struct)
...
int main(int argc, char* argv[])
{
    ...
    std::string vertexShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial7/Shaders/Main.glsl.vert));
    ...
    std::string fragmentShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial7/Shaders/Main.glsl.frag));
