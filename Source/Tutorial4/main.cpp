...
int main(int argc, char* argv[])
{
    ...
    std::string vertexShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial4/Shaders/Main.vs));
    ...
    std::string fragmentShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial4/Shaders/Main.fs));
