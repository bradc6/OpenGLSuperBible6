...
int main(int argc, char* argv[])
{
    ...
    std::string vertexShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial6/Shaders/Main.vs));
    ...
    std::string fragmentShaderSource = LoadFileToString(QUOTE(SOURCEDIR/Source/Tutorial6/Shaders/Main.fs));
